              ...
              <div className="absolute left-[-283px] top-[calc(100%-8px)] invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-150 ease-in-out">
                <div className="pt-4">
                  <div className="bg-white rounded-lg shadow-lg p-4 w-[500px]">
                    ...
                    <Link href="/investment-info" className="flex items-center space-x-4 p-3 hover:bg-gray-50 rounded-lg mt-2 transition duration-150">
                      <div className="bg-[#5BB5D1] rounded-full p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Link href="/tax-information" className="flex items-center space-x-4 p-3 hover:bg-gray-50 rounded-lg mt-2 transition duration-150">
                      <div className="bg-[#5BB5D1] rounded-full p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Link href="/deposit-protection" className="flex items-center space-x-4 p-3 hover:bg-gray-50 rounded-lg mt-2 transition duration-150">
                      <div className="bg-[#5BB5D1] rounded-full p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
